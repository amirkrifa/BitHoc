...
/*!
* \file LogFile.cpp
* \brief Implementation of the class LogFile used to write and manage log files generated by the tracker.  
...
LogFile::LogFile(std::string file)
{
	...
	CreateDirectory( ConvertLPCSTRToLPWSTR(".\\WM-BITTORRENT-LOG-FILES\\"),NULL);
	file_name.append(".\\WM-BITTORRENT-LOG-FILES\\");
	file_name.append(file);
	DeleteFile(ConvertLPCSTRToLPWSTR((char*)file_name.c_str()));
