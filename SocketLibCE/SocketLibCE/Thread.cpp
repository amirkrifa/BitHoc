...
//	m_thread = ::CreateThread(NULL, 0, StartThread, this, 0, &m_dwThreadId);
	m_thread = (HANDLE)CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)&Thread::StartThread,(LPVOID) this, 0,(LPDWORD)&m_dwThreadId);
#else
	pthread_attr_t attr;
...
UINT Thread::StartThread(threadparam_t zz)
{
	Thread *p = (Thread *)zz;
